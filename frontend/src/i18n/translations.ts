export const translations = {
  en: {
    ...
    checklists: {
      ...
      searchPlaceholder: "Search by checklist title, category or item...",
      noResults: "No checklists found.",
    ...
    interview: {
      ...
      searchPlaceholder: "Search by question, category or answer...",
  ...
  ru: {
    ...
    checklists: {
      ...
      searchPlaceholder: "Поиск по названию, категории или пункту чек-листа...",
      noResults: "Чек-листы не найдены.",
    ...
    interview: {
      ...
      searchPlaceholder: "Поиск по вопросу, категории или ответу...",
